import random#Presetting
from flask import Flask, render_template, request, make_response, redirect, url_for#Presetting
from models import User#Presetting
...
def result():
    guess = int(request.form.get("guess"))#Input value from the <form>
